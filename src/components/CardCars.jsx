                            ...
                            return (
                                <>
                                    <Col xl="4" md='6' sm='12' className='mt-3' >
                                        <Card className='cars-cards' id={item.id} style={{ height:'660px', width:'416px' }}>
                                            <div className='card-wrap w-100'>
                                                <div >
                                                    <CardImg
                                                        alt="Card image"
                                                        src={item.image}
                                                        style={{ maxHeight:'314px', minHeight:'314px' }}
                                                    />
                                                </div>
                                                <div className="card-item">
                                                    <CardText>
                                                        ...
                                                        <div >
                                                            <MdDateRange />
                                                            <span className='ms-2'>Tahun {item.time}</span>
                                                        </div>
                                                    </CardText>
                                                    <Link to={`/cars/detail/${item.id}`}>
                                                        <Button className='btn btn-success' style={{ height: '48px' }}>
                                                            {btn}
                                                        </Button>
                                                    </Link>
                                                </div>
